...
import com.mountreachsolution.farmlabourscheduling.FARMER.Adpter.AdpterAllWaiting;
...
public class waitingrequest extends AppCompatActivity {
    ...
    String monilenumber;
    AdpterAllWaiting adpterRequestWork;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_waitingrequest);
        getWindow().setStatusBarColor(ContextCompat.getColor(waitingrequest.this, R.color.lightbrown));
        getWindow().setNavigationBarColor(ContextCompat.getColor(waitingrequest.this, R.color.white));
        ...
        waitingRequest = new WaitingRequest(waitingrequest.this);
        ...
        adpterRequestWork = new AdpterAllWaiting(filteredId, filteredName, filteredMobileno, filteredAddress, filteredWork, filteredWages,
                filteredStarttime, filteredEndtime, filteredWorkdate, filteredCrop, image1, labour1,
                labourname1, labournumber1, labouraddress1, labourskill1, labouradhar1, labourage1,waitingrequest.this);
        rvlist.setLayoutManager(new LinearLayoutManager(waitingrequest.this));
    ...
    private void getalldata(String monilenumber) {
        ...
        Cursor cursor = waitingRequest.getRequest(monilenumber);
