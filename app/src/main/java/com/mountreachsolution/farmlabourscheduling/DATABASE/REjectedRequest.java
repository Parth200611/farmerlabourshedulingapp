...
public class REjectedRequest extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "RejectedWork.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME = "Reject_work";
    ...
    public REjectedRequest(@Nullable Context context) {
