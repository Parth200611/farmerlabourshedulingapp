...
public class Acceptedworkd extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "acceptedWork.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME = "accepted_work";
    ...
    public Acceptedworkd(@Nullable Context context) {
